...
// ------------------------------------
//
// Robot is vertically oriented,
// so the thrust particles travel DOWN.
// ------------------------------------
...
if (robot_typing || robot_message_index > 0)
{
    var displayed_text =
        string_copy(
            robot_message,
    ...
    draw_set_alpha(robot_text_alpha);
